...
<nav class="navbar navbar-expand-lg bg-light shadow-lg">
		        ...
		        <div class="card" style="border-radius: 1rem;">
		          <div class="row g-0">
		            <div class="col-md-6 col-lg-5 d-none d-md-block">
		               <img src="login/images/send.png" alt="login" width="380" height="400" style="margin:20px 50px 20px " />
		                <br>
		            </div>
    ...
    style="width:100px;height:100px">
                  ...
                  <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Messaggio Inviato!</h5>
                  ...
                  <div class="pt-1 mb-4">
                    <a href="dipendente">
                    <button class="btn btn-success btn-lg btn-block">Torna a Pannello Dipendente</button>
                    </a>
                  </div>

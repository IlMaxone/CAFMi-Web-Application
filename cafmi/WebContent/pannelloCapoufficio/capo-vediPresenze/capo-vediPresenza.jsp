...
<html lang="en">
    <head>
        ...
        int codice_cliente = (int)request.getAttribute("id");
    		String cartella = "C:\\JSON\\list_timb_dip\\";
    		File nomefile = new File(codice_cliente+"_timbrature_dip.json");
    ...
    <!-- NAVBAR SIDE-->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">VISUALIZZA ORE TIMBRATE</h1>
        ...
        <!-- JS X NAVBAR -->
        <script src="pannelloCapoufficio/capo-vediPresenze/capo-vediPresenze-js.js"></script>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        <title>CAFMi | Pannello Admin</title>
        <link href="https://cdn.jsdelivr.net/npm/simple-datatables@latest/dist/style.css" rel="stylesheet" />
        <script src="https://use.fontawesome.com/releases/v6.1.0/js/all.js" crossorigin="anonymous"></script>
        <!-- CSS -->
        <link href="pannelloCapoufficio/capo-aggiornaUser/capo-aggiornaUser-style.css" rel="stylesheet" />  
        <!-- Favicon-->
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <a class="navbar-brand ps-3" href="dirigente">
                <img src="pannelloCapoufficio/capo-aggiornaUser/img/logo-banner.png" alt="CAFMi logo-banner" width="100px" height="30px">
            </a>
            <!-- Sidebar Toggle-->
        ...
        <!-- JS X NAVBAR -->
        <script src="capo-aggiornaUser-js.js"></script>
    </body>
</html>

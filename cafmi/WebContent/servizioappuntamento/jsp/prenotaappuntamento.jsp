...
<html lang="en">
    <head>
		...
		<!-- FAVICON -->
        <title>CAFMi | Prenota appuntamento</title>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mx-auto">
                            <form class="custom-form donate-form" action="appuntamento_prenotato" method="post" role="form">
                                <h3 class="mb-4">Prenota un appuntamento</h3> 
                                  <h5 class="mb-3">Completa i campi per richiedere un appuntamento</h5> 
                                ...
                                String telefono = user.getNumero_telefono();%>
                                
                                    <fieldset>
                                      <legend><span class="number">1</span>Dettagli personali</legend>
                                      <label for="name">Nome*:</label>
                                      <input type="text" id="name" name="user_name" placeholder="" required pattern="[a-zA-Z0-9]+" required value="<%=nome%>" readonly>
                                      
                                      <label for="name">Cognome*:</label>
                                      <input type="text" id="lastname" name="last_name" placeholder="" required pattern="[a-zA-Z0-9]+" required value="<%=cognome%>" readonly>
                              
                                      <label for="mail">Email*:</label>
                                      <input type="email" id="mail" name="user_email" placeholder="abc@gmail.com" required value="<%=email%>" readonly>
                              
                                      <label for="tel">Numero di telefono*:</label>
                                      <input type="tel" id="tel" placeholder="" name="user_num" required pattern="[0-9]+" value="<%=telefono%>" readonly>
                              
                              
                                    </fieldset>
                              
                                    <fieldset>
                                      <legend><span class="number">2</span>Dettagli appuntamento</legend>
                                      <label for="appointment_for" value="ciao">Appuntamento per*:</label>
                                      <select id="appointment_for" name="appointment_for" required>
                                        <option value="permesso">Permesso soggiorno</option>
                                        <option value="ricongiungimento">Ricongiungimento familiare</option>
                                        <option value="cittadinanza">Cittadinanza italiana</option>
                                        <option value="spid">Spid</option>                                     
                                      </select>
                                      <label for="appointment_description">Descrizione:</label>
                                      <textarea id="appointment_description" name="appointment_description" placeholder="Indica il motivo della richiesta di appuntamento"></textarea>
                                      ...
                                      <br>
                                      <label>Riceverai via email i dettagli dell'appuntamento</label>
                                   
                                    </fieldset>
                                    <button type="submit"class="form-control mt-4" href="(riepilogoappuntamento.jsp)">Richiedi Appuntamento</button>
